...
export class InsertionComponent implements OnInit {
  ...
  dataFirstB = {
    label: "",
            data: this.insertion(this.bestData),
            lineTension: 0.3,
            fill: false,
            borderColor: 'red',
  ...
  dataFirstM = {
    label: "",
            data: this.insertion(this.mediumData),
            lineTension: 0.3,
            fill: false,
            borderColor: 'red',
            backgroundColor: 'transparent',
  ...
  dataFirstW = {
    label: "",
            data: this.insertion(this.worstData),
            lineTension: 0.3,
            fill: false,
            borderColor: 'red',
            backgroundColor: 'transparent',
  ...
  ngOnInit() : void {
    this.chartBest = new Chart('bestI', {
      type: 'line',
      data: this.speedDataB,
      options: this.chartOptions
    });

    this.chartPromediate = new Chart('promediateI', {
      type: 'line',
      data: this.speedDataM,
      options: this.chartOptions
    });

    this.chartWorst = new Chart('worstI', {
      type: 'line',
